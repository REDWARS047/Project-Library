...
// @ts-nocheck
    ...
    function backToRFIDSCAN() {
		goto('/'); // Adjust '/dashboard' as needed based on your routing setup
	}
  ...
  <button class="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700" on:click={backToRFIDSCAN}>Go back</button>